...
<html lang="{{ app()->getLocale() }}">
	...
	<body>
	            ...
	            <div class="container">
	                ...
	                <div class="collapse navbar-collapse" id="app-navbar-collapse">
	                    ...
	                    <ul class="nav navbar-nav">
	                        ...
	                        @endif
	                        @if (Auth::user()->authorizeRoles(array('Administrator', 'Executive', 'Contracts', 'Field Lead', 'Field Coordinator', 'Project Manager', 'Field Crew', 'Sales Manager')))
	                        <li class="dropdown">
	                        	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
	    ...
	    <script src="{{ URL::asset('/js/account_settings.js' ) }}"></script>
