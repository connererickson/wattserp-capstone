	                ...
	                <div class="row">
	                	<div class="col-md-12">
		                	<div id='create_training_form'>
		                		{!! Form::open(['method'=>'POST', 'action'=>'SlideController@store_slide', 'class'=>'crm_form', 'files' => true]) !!}
		                		<div class="row">
			                		<div class='col-md-6'>
				                		...
				                		<div class='form-group'>
				                			{!! Form::hidden('training_course_id', $training_course_id, ['class'=>'form-control']) !!}
				                			{!! Form::submit('Create Slide', ['class'=>'crm_btn', 'id'=>'submit_form']) !!}
