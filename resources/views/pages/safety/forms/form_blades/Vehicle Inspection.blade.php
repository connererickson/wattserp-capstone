        ...
        {{ csrf_field() }}
            ...
            <div class="mb-3">
                ...
                <select name="truck" class="form-select" required>
                    ...
                    <option value="105 - F250">105 - F250</option>
                    <option value="106 - F250 Ladder Rack">106 - F250 Ladder Rack</option>
                    <option value="323 - Chevy">323 - Chevy</option>
                    <option value="332 - Flatbed">332 - Flatbed</option>
                </select>
            </div>
            <div class="mb-3">
                ...
                <select name="trailer" class="form-control" required>
                    <option style="display: none;">-- Select your answer --</option>
                    <option value="T-14DT - Flat">T-14DT - Flat</option>
                </select>
            </div>
            <div class="mb-3">
              <label for="equipmentLabel" class="form-label">Equipment:</label>
              <input name="equipment" type="text" class="form-control" id="equipmentLabel" required>
            </div>
            <div class="mb-3">
                <label for="startingODOLabel" class="form-label">Starting Odometer Mileage:</label>
                <input name="startingMileage" type="text" class="form-control" id="startingODOLabel" required>
            </div>
            <div class="mb-3">
                <label for="endingODOLabel" class="form-label">Ending Odometer Mileage:</label>
                <input name="endingMileage" type="text" class="form-control" id="endingODOLabel" required>
            </div>
            <div class="mb-3">
